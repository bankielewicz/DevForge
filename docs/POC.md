...
```bash
target/debug/devforge --project <project> install framework --framework ../DevForgeAI --provider both --include-experts --runtime <single-link copy of devforge>
```
